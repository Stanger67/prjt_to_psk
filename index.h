...
void ncoderrr ()
    ...
    { //если она отлична от старой
        ...
        { //начальная позиция не интересует
            if (ptw::br_int >= 1)
            {
               ...
               if (ptw::br_int == 2 )
                   {
                       alarm_all [2] = newPosition - ptw::oldPosition + alarm_all [2];
      ...
      if (ptw::br_int == 6 )
      {
        alarm_all [4] = newPosition - ptw::oldPosition + alarm_all [4];
        ...
        if (ptw::br_int < 1) { 
    if (h == 0){
    ptw::alarm_hour[1] newPosition - oldPosition + alarm_hour [1];
    ptw::alarm_hour[1] = abs(ptw::alarm_hour [1]);
    lcd.setCursor (10, 0);
    lcd.print (ptw::alarm_hour [1]);
    if (ptw::alarm_hour [1] >= 23)
     ...
     if (h == 1){
     alarm_all [1] = newPosition - ptw::oldPosition + alarm_all [1];
